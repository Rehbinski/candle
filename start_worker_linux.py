...
from Forensic_function.workercount import *
...
def main():
    ...
    workerlist('Ewfmount', routingkeysVorbedingung.get('Ewfmount'), getEwf)
    ...
    workerlist('Plus', 'plus', workerplus)
    workerlist('Minus', 'minus', workerminus)
